...
New Relic has been added to the project.
* `NEW_RELIC_LICENSE_KEY`: Required to publish APM to New RElic. Format is a '40HexadecimalCharacters' string.
* `NEW_RELIC_APP_NAME`: Unique application name for your New Relic sub-account.
